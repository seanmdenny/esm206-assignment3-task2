---
title: "Assignment 3, Task 2 - ESM 206"
...
library(lubridate) (`lubridate` is a package to make it a bit easier to work with dates & times)
separate()
unite()
group_by
count()
...
- Run the setup chunk to get the `tidyverse` & `lubridate` packages attached 
...
some_dates <- c(11022020, 11032020, 11042020)
